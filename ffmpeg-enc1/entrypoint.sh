...
drawtext=text='video-720p25-1000k': fontsize=32: x=(w-text_w)/2: y=125: fontsize=32: fontcolor=white, \
...
-map "[vid]" -s 1280x720 -c:v libx264 -b:v 1000k -profile:v main -preset ultrafast -tune zerolatency \
-g $GOP_LENGTH \
-r $FRAME_RATE \
